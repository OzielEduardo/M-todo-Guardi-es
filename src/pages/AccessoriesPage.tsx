      ...
      <nav className="fixed top-0 w-full z-50 bg-sombra backdrop-blur-xl border-b border-white/[0.03]">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="text-sm font-medium text-white group-hover:text-sagrado transition-colors uppercase tracking-widest">Início</span>
          </Link>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-20 text-white">
            <div>
              ...
              <p className="text-white text-lg max-w-2xl mx-auto leading-relaxed italic">
                Prepare seu <span className="font-bold">herói</span> com a <span className="text-sagrado font-bold">armadura certa</span> para sua jornada. Cada peça carrega o <span className="font-bold">legado dos Guardiões</span>.
              </p>
            </div>
          </div>
          ...
          {products.length > 0 ? (
                ...
                >
                  ...
                  >
                    <img 
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-sombra to-transparent" />
                  ...
                  <div className="p-10 text-center">
                    <h3 className="text-2xl font-bold mb-3 tracking-tight text-white">{p.name}</h3>
            ...
            >
              <ShoppingBag className="w-16 h-16 text-sagrado mx-auto mb-6 opacity-30" />
              <p className="text-white uppercase tracking-[0.3em] font-bold text-sm">Novos itens em breve</p>
            </div>
          )}
        </div>
      </main>
        ...
        {selectedImg && (
          ...
          >
            ...
            >
              <button 
                onClick={() => setSelectedImg(null)}
                className="absolute -top-12 right-0 md:-right-12 text-white hover:text-sagrado transition-colors p-2"
              >
                <X className="w-8 h-8" />
              </button>
              <img 
      ...
      <footer className="py-20 border-t border-white/[0.03] bg-black/20">
        <div className="max-w-7xl mx-auto px-4 flex flex-col items-center gap-10">
          <Link to="/" className="flex flex-col items-center gap-6 text-white text-[11px] uppercase tracking-[0.3em] font-bold group">
            <div className="w-16 h-16 flex items-center justify-center rounded-full overflow-hidden bg-sombra border border-white/10 group-hover:border-white/30 transition-all">
              <img 
                src={IMAGES.LOGO} 
                alt="Logo" 
                className="w-full h-full object-contain scale-125"
